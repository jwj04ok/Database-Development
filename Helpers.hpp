...
namespace ECE141 {
  ...
  static std::map<std::string,  Keywords> gDictionary = {
    ...
    std::make_pair("timestamp", ECE141::Keywords::datetime_kw),
  ...
  public:
    ...
    static DataType getDataTypeForKeyword(Keywords aKeyword) {
        ...
        case Keywords::datetime_kw: return DataType::datetime_type;
      ...
      static DataType getDataTypeForString(std::string aStr) {
          if (aStr=="B") return DataType::bool_type;
          else if (aStr == "D") return DataType::datetime_type;
          else if (aStr == "F") return DataType::float_type;
          else if (aStr == "I") return DataType::int_type;
          else if (aStr == "V") return DataType::varchar_type;
          else return DataType::no_type;
      }
      
      static std::string getStrForDataType(DataType aType) {
          switch (aType) {
          case DataType::bool_type:return "B";
          case DataType::datetime_type:return "D";
          case DataType::float_type:return "F";
          case DataType::int_type:return "I";
          case DataType::varchar_type:return "V";
          default: return "N";
          }
      }
